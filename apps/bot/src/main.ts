...
// bot.on('chosen_inline_result', (data) =>
//   console.log('chosen_inline_result', data)
// );
// bot.on('edited_channel_post', (data) =>
//   console.log('edited_channel_post', data)
// );
...
// bot.on('message_reaction_count', (data) =>
//   console.log('message_reaction_count', data)
// );
